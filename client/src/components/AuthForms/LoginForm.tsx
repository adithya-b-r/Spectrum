  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 mt-1 mb-5">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full text-sm text-gray-800 dark:text-slate-100 bg-slate-50/60 dark:bg-slate-800/60 hover:bg-slate-50 dark:hover:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 pl-10 pr-10 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-950 outline-none transition duration-150 placeholder-gray-400 dark:placeholder-slate-500"
              />
              <button
                type="button"
        ...
        <p className="text-center text-xs sm:text-sm text-gray-500 dark:text-slate-400 mt-5">
