      ...
      <div onClick={(e) => e.stopPropagation()} className="relative bg-white w-10/12 md:w-1/3 h-fit rounded-lg flex flex-col items-center justify-center p-4 py-6 md:py-8">
        ...
        <form onSubmit={handleFormSubmit} method="post">
          ...
          <input
            type="submit"
            value="Login"
            className="tracking-wider bg-blue-600 hover:bg-blue-700 duration-200 w-full text-lg text-white cursor-pointer border border-gray-300 outline-none py-2 px-3 rounded-md mt-4"
          />
        </form>
        ...
        <div className="hover:bg-slate-100 duration-200 w-full border border-gray-300 flex items-center mt-4 rounded-md">
          <svg
            className="w-1/12 bx bxl-google text-2xl ml-3 h-6"
          ...
          <input
            ...
            className="bg-transparent w-11/12 text-lg text-gray-600 cursor-pointer outline-none py-2 px-3 rounded-md"
          />
        </div>
      </div>
    </div>
